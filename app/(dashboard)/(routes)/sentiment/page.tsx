...
// 				Text <span className="text-primary">Sentiment</span> Analysis
// 				App
// 			</h2>
...
export default function Home() {
	...
	return (
		<div className="flex flex-col items-center relative min-h-screen">
			<h2 className="font-raleway font-bold text-6xl text-primary pt-20 pb-6 md:text-3xl">
				Text <span className="text-primary text-blue-500">Sentiment</span> Analysis
				App
			</h2>
			<h3 className="text-danger text-2xl font-raleway font-bold uppercase tracking-wide mb-12 md:text-base md:px-4 md:text-center">
				Check how your text sounds
			...
			<div className="flex justify-between w-5/6 h-96 mt-8 md:flex-col md:items-center md:justify-start">
				...
				<div className="flex items-center">
					<button
						className="h-1/6 outline-none border border-secondary font-bold font-raleway mx-12 px-8 rounded-sm bg-blue-500 text-primary transition duration-300 hover:bg-blue-700 text-white md:h-16 md:my-12"
			...
			<div className="absolute bottom-0 flex justify-center items-end h-52 md:h-44">
				<p className="text-primary mt-22 md:w-60 md:text-center">
					Made by RapidAPI DevRel Team And use by Relay team for hackathon –{' '}
